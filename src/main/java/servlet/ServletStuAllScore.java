  ...
  stuNum=request.getParameter("stunum"); double
  rs=scoreServiceImpl.findStuSc(stuNum); out.print(rs);
  request.setAttribute("sum", rs);
  request.getRequestDispatcher("admin/stuScore.jsp").forward(request,
  response);
